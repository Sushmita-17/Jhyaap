...
import { Bell, Clock, CreditCard, Menu, Phone, Search, ShoppingCart, User, X, Minus, Plus, Sun, Moon, Grid3X3, SlidersHorizontal } from 'lucide-react';
        ...
        <>
          ...
          <div className={`fixed top-0 right-0 bottom-0 z-[1101] w-[75vw] max-w-[300px] border-l flex flex-col md:hidden shadow-2xl ${
            ...
            <div className={`px-4 py-3 border-t ${
              ...
              <p className={`text-[10px] text-center ${isLight ? 'text-gray-500' : 'text-[#555555]'}`}>📞 {STORE_INFO.phone} &middot; 6PM&ndash;2AM</p>            </div>
          </div>
        </>
      )}
    </header>

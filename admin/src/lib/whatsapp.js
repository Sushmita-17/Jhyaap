...
export const whatsappMessages = {
  ...
  orderQuestion: (orderId) => `Hi, I have a question about order #${orderId}`,
};

export const whatsappLinks = {
  order: () => whatsappUrl(whatsappMessages.orderIntent),
  support: () => whatsappUrl(whatsappMessages.support),
  product: (name, price) => whatsappUrl(whatsappMessages.productInquiry(name, price)),
  orderById: (orderId) => whatsappUrl(whatsappMessages.orderQuestion(orderId)),
};

    ...
    <div className="mx-auto max-w-7xl space-y-6 md:space-y-8 animate-fade-in">
      ...
      {orders.length > 0 && (
        <div className="panel overflow-hidden bg-gradient-to-br from-[#1A1A1A]/80 to-[#0F0F0F]/80 backdrop-blur-xl border border-white/10 hover:border-[#C9A84C]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#C9A84C]/20 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#C9A84C]/5 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500" />
          <div className="relative border-b border-white/10 px-6 py-5 bg-[#0A0A0A]/30">
          ...
          <div className="relative overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="bg-[#0A0A0A]/60 text-xs uppercase tracking-wider text-[#888888]">
                <tr>
              ...
              <tbody className="divide-y divide-white/5">
                {orders
                  ...
                  .slice(0, 5)
                  .map((order) => (
                    <tr key={order.id} className="hover:bg-white/[0.05] hover:shadow-lg hover:shadow-[#C9A84C]/10 transition-all duration-300">
                      <td className="px-6 py-4 font-mono text-xs text-[#888888] group-hover:text-[#C9A84C] transition-colors">{order.id}</td>
                      <td className="px-6 py-4 text-white font-semibold group-hover:text-[#C9A84C] transition-colors">Rs {order.total.toLocaleString()}</td>
                      ...
                      <td className="px-6 py-4 text-[#666666] group-hover:text-[#888888] transition-colors">

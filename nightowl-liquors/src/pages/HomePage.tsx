              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-[#C9A84C] to-[#B8943D] text-black text-[12px] font-bold uppercase tracking-[0.1em] rounded-lg hover:from-[#D4B85C] hover:to-[#C9A84C] transition-all shadow-lg shadow-[#C9A84C]/20"
                  >
                    View Details
                  </button>
                  <div className={`flex items-center gap-3 border px-5 py-3 rounded-2xl ${
                    isLight 
                    ...
                    <div className="flex -space-x-2">
                      {[1,2,3].map(i => (
                        <div key={i} className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                          isLight 
                            ? 'border-gray-200 bg-gray-300' 
                            : 'border-[#1E1614] bg-[#2A201C]'
                        }`}>
                          <User className="w-3 h-3 text-[#C9A84C]" />
                        </div>
                      ))}
                    </div>
                    <p className={`text-[12px] font-medium ${isLight ? 'text-gray-700' : 'text-[#F5ECD7]'}`}>
            ...
            <div className={`border-b px-3 py-3 ${
              ...
              <div className="grid grid-cols-[1fr_auto_auto] items-center gap-2">
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  <button
                    onClick={() => { setOnlyDeals(true); setPage('products'); }}
                    className="text-[8px] text-[#C9A84C] font-bold hover:underline whitespace-nowrap"
                  >
                    View all deals {'->'}
                  </button>
                </div>
...
function FaqItem({ item, isLight }: { item: { q: string, a: string }, isLight: boolean }) {

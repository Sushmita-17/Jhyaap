...
export function buildCategories(
  ...
  return [...ids]
    .map((id) => {
      ...
      return {
        id,
        name: customCat?.name ?? meta?.name ?? id,
...
export const DEFAULT_BANNERS: BannerSlide[] = [
  {
    ...
    subtitle: 'Check the bottle, size, and price yourself. Pay COD, eSewa, or Khalti — whatever works for you.',
  ...
  {
    id: 'jhyaap-2',
    title: 'Kathmandu · Lalitpur · Bhaktapur',
  ...
  },
  {
    ...
    subtitle: 'Whisky, beer, wine — order from Bhaktapur and get it across the valley when most shops are shut.',

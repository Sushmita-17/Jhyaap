...
import { DEFAULT_BANNERS, buildCategories } from '@/lib/catalogUtils';
...
export const useCatalogStore = create((set, get) => ({
  ...
  fetchProducts: async () => {
    ...
    try {
      ...
      const response = await fetch(API_PRODUCTS_URL).catch(() => null);
    ...
    // Fallback to local storage or raw base catalog

        ...
        <div className="mb-2 px-[6px] md:mb-3 md:px-[8px] lg:mb-4 lg:px-[16px]">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            {onAction && (
              <button
                onClick={onAction}
                className={`shrink-0 rounded-full border px-3 py-1.5 text-[10px] font-bold transition-colors hover:border-[#C9A84C]/40 hover:bg-[#C9A84C]/10 hover:text-white inline-flex lg:text-[11px] ${
                  isLight 
